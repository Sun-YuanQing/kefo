Page({
  ...
  onLoad: function (options) {
    ...
    // 定义方框的位置和尺寸
    let _cropBorder = {}
    _cropBorder.size = systemInfo.windowWidth * 0.75
      ...
      wx.canvasToTempFilePath({
        ...
        success: function (data) {
          ...
          if (pages.length > 1) {
            ...
            prePage.changePhoto('Photo', data.tempFilePath);
            // prePage.data.personalInfor.avatar = data.tempFilePath;
            // prePage.setData({
            //   personalInfor: prePage.data.personalInfor
            // })
          }
          wx.navigateBack()
        },
